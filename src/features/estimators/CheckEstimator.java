 ...
 * estimators. If you implement a estimator using the features.libraries,
 ...
 * 
 * Typical usage: <p/>
 * <code>java features.estimators.CheckEstimator -W estimator_name 
 ...
 *
 * The <code>features.estimators.AbstractEstimatorTest</code> uses this
 ...
 *  eg: features.estimators.NormalEstimator</pre>
 * 
 * <pre> 
 * Options specific to estimator features.estimators.NormalEstimator:
 * </pre>
 * 
 * <pre> -D
...
public class CheckEstimator implements OptionHandler, RevisionHandler {
  ...
  protected Estimator m_Estimator = (Estimator) new features.estimators.NormalEstimator(0.000001);
  ...
  public Enumeration listOptions() {
    ...
    newVector.addElement(new Option(
        "\tFull name of the estimator analysed.\n"
        +"\teg: features.estimators.NormalEstimator",
        "W", 1, "-W"));
