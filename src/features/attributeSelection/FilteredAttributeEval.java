 ...
 *  eg: "features.attributeSelection.InfoGainAttributeEval -M"</pre>
 * 
 * <pre> -F &lt;filter specification&gt;
 *  Full class name of filter to use, followed
 *  by filter options.
 *  eg: "features.filters.supervised.instance.SpreadSubsample -M 1"</pre>
 * 
 <!-- options-end -->
 *
...
public class FilteredAttributeEval
  ...
  /** Filter */
  protected Filter m_filter = new features.filters.supervised.instance.SpreadSubsample();
  ...
  public Enumeration listOptions() {
    ...
    newVector.addElement(new Option(
                                    ...
                                    +"evaluator options.\n"
                                    + "\teg: \"features.attributeSelection.InfoGainAttributeEval -M\"",
                                    "W", 1, "-W <evaluator specification>"));

    newVector.addElement(new Option(
	      "\tFull class name of filter to use, followed\n"
	      + "\tby filter options.\n"
	      + "\teg: \"features.filters.supervised.instance.SpreadSubsample -M 1\"",
  ...
  public void setOptions(String[] options) throws Exception {
	...
	throw new IllegalArgumentException("Invalid filter specification string");
      ...
      setFilter(new features.filters.supervised.instance.SpreadSubsample());
    }
  }
