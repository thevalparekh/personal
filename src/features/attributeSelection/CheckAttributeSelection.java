...
package features.attributeSelection;
 ...
 * the features.libraries, you should run the checks on it to ensure robustness 
 ...
 * 
 * Typical usage: <p/>
 * <code>java features.attributeSelection.CheckAttributeSelection -W ASscheme_name 
 ...
 *
 * The <code>features.attributeSelection.AbstractAttributeSelectionTest</code> 
 ...
 *  eg: features.attributeSelection.CfsSubsetEval</pre>
 * 
 * <pre> -search name [options]
 *  Full name and options of the search method analyzed.
 *  eg: features.attributeSelection.Ranker</pre>
 * 
 ...
 * 
 * <pre> 
 * Options specific to search method features.attributeSelection.Ranker:
 * </pre>
 * 
 * <pre> -P &lt;start set&gt;
...
public class CheckAttributeSelection 
  ...
  public Enumeration listOptions() {
    ...
    result.addElement(new Option(
        "\tFull name and options of the evaluator analyzed.\n"
        +"\teg: features.attributeSelection.CfsSubsetEval",
        "eval", 1, "-eval name [options]"));
    
    result.addElement(new Option(
        "\tFull name and options of the search method analyzed.\n"
        +"\teg: features.attributeSelection.Ranker",
