 ...
 *  (default: features.attributeSelection.ReliefFAttributeEval)</pre>
 * 
 * <pre> 
 * Options specific to evaluator features.attributeSelection.ReliefFAttributeEval:
 * </pre>
 * 
 * <pre> -M &lt;num instances&gt;
...
public class CostSensitiveAttributeEval
  ...
  public String defaultEvaluatorString() {
    return "features.attributeSelection.ReliefFAttributeEval";
  }
