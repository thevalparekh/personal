 ...
 * associators. If you implement an associators using the features.libraries,
 ...
 * 
 * Typical usage: <p/>
 * <code>java features.associations.CheckAssociator -W associator_name 
 ...
 *
 * The <code>features.associations.AbstractAssociatorTest</code> uses this
 ...
 *  eg: features.associations.Apriori
 *  (default features.associations.Apriori)</pre>
 * 
 * <pre> 
 * Options specific to associator features.associations.Apriori:
 * </pre>
 * 
...
public class CheckAssociator
  ...
  protected Associator m_Associator = new features.associations.Apriori();
  ...
  public Enumeration listOptions() {
    ...
    result.addElement(new Option(
        "\tFull name of the associator analysed.\n"
        +"\teg: features.associations.Apriori\n"
        + "\t(default features.associations.Apriori)",
        "W", 1, "-W"));
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    if (tmpStr.length() == 0)
      tmpStr = features.associations.Apriori.class.getName();
    setAssociator(
	(Associator) forName(
