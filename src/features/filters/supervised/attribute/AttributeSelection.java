...
package features.filters.supervised.attribute;
...
import features.attributeSelection.AttributeEvaluator;
import features.attributeSelection.AttributeTransformer;
import features.attributeSelection.BestFirst;
import features.attributeSelection.CfsSubsetEval;
import features.attributeSelection.Ranker;
import features.attributeSelection.UnsupervisedAttributeEvaluator;
import features.attributeSelection.UnsupervisedSubsetEvaluator;
...
import features.core.SparseInstance;
 ...
 *  eg. -S "features.attributeSelection.BestFirst -S 8"</pre>
 * 
 * <pre> -E &lt;"Name of attribute/subset evaluation class [evaluator options]"&gt;
 *  Sets attribute/subset evaluator.
 *  eg. -E "features.attributeSelection.CfsSubsetEval -L"</pre>
 * 
 * <pre> 
 * Options specific to evaluator features.attributeSelection.CfsSubsetEval:
 * </pre>
 * 
 * <pre> -M
 ...
 * 
 * <pre> 
 * Options specific to search features.attributeSelection.BestFirst:
 * </pre>
 * 
 * <pre> -P &lt;start set&gt;
...
public class AttributeSelection 
  ...
  private features.attributeSelection.AttributeSelection m_trainSelector;
  ...
  public Enumeration listOptions() {
	...
	"\tSets search method for subset evaluators.\n"
	+ "\teg. -S \"features.attributeSelection.BestFirst -S 8\"", 
	"S", 1,
	"-S <\"Name of search class [search options]\">"));

    newVector.addElement(new Option(
	"\tSets attribute/subset evaluator.\n"
	+ "\teg. -E \"features.attributeSelection.CfsSubsetEval -L\"",
	"E", 1,
  ...
  public Capabilities getCapabilities() {
    ...
    if (m_ASEvaluator == null) {
      ...
      //   features.attributeSelection.AttributeSelection.SelectAttributes(Instances)
  ...
  protected void resetOptions() {
    ...
    m_trainSelector = new features.attributeSelection.AttributeSelection();
