...
import features.core.RelationalLocator;
import features.core.RevisionHandler;
import features.core.RevisionUtils;
import features.core.SerializedObject;
import features.core.StringLocator;
import features.core.UnsupportedAttributeTypeException;
...
public abstract class Filter
  ...
  public static String wekaStaticWrapper(
    ...
    result.append("package features.filters;\n");
    result.append("\n");
    ...
    result.append("import features.core.FastVector;\n");
    result.append("import features.core.Instance;\n");
    result.append("import features.core.Instances;\n");
    result.append("import features.filters.Filter;\n");
    result.append("\n");
   ...
   * -o output_file <br/>
   * -c class_index <br/>
   * -z classname (for filters implementing features.filters.Sourcable) <br/>
