...
import features.clusterers.AbstractDensityBasedClusterer;
 ...
 *   features.clusterers.EM
 *  Additional options after the '--'.
 *  (default: features.clusterers.EM)</pre>
 * 
...
public class ClusterMembership 
  ...
  /** The clusterer */
  protected DensityBasedClusterer m_clusterer = new features.clusterers.EM();
  ...
  public Enumeration listOptions() {
    ...
    newVector.
      addElement(new Option("\tFull name of clusterer to use. eg:\n"
	                    + "\t\tfeatures.clusterers.EM\n"
			    + "\tAdditional options after the '--'.\n"
			    + "\t(default: features.clusterers.EM)",
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    if (clustererString.length() == 0)
      clustererString = features.clusterers.EM.class.getName();
