 ...
 *   "features.clusterers.SimpleKMeans -N 3"
...
public class AddCluster 
  ...
  protected Clusterer m_Clusterer = new features.clusterers.SimpleKMeans();
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    if (clustererString.length() == 0)
      clustererString = features.clusterers.SimpleKMeans.class.getName();
