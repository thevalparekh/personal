...
package features.filters.unsupervised.attribute;
...
import features.filters.AllFilter;
import features.filters.Filter;
import features.filters.SimpleBatchFilter;
import features.filters.UnsupervisedFilter;
 ...
 * By default, the data is preprocessed with the Center filter, but the user can choose any filter (NB: one must be careful that the filter does not alter the class attribute unintentionally). With features.filters.AllFilter the preprocessing gets disabled.<br/>
 * <br/>
 ...
 *  The Filter used for preprocessing (use features.filters.AllFilter
 *  to disable preprocessing).
 *  (default: features.filters.unsupervised.attribute.Center)</pre>
 * 
 * <pre> 
 * Options specific to kernel features.classifiers.functions.supportVector.PolyKernel:
 * </pre>
 * 
 * <pre> -D
 ...
 * 
 * <pre> 
 * Options specific to preprocessing filter features.filters.unsupervised.attribute.Center:
 * </pre>
 * 
...
public class KernelFilter
  ...
  public String globalInfo() {
    return 
      ...
      + "features.filters.AllFilter the preprocessing gets disabled.\n\n"
