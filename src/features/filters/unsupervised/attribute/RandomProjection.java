...
public class RandomProjection 
  ...
  protected Filter m_ntob; // = new features.filters.unsupervised.attribute.NominalToBinary();
  ...
  public String replaceMissingValuesTipText() {
    ...
    return "If set the filter uses features.filters.unsupervised.attribute.ReplaceMissingValues"
  ...
  public boolean setInputFormat(Instances instanceInfo) throws Exception {      
    ...
    */
	...
	if( i!=instanceInfo.classIndex() && instanceInfo.attribute(i).isNominal() ) {
            if(instanceInfo.classIndex()>=0)
                m_ntob = new features.filters.supervised.attribute.NominalToBinary();
            else
                m_ntob = new features.filters.unsupervised.attribute.NominalToBinary();
	...
	m_replaceMissing = new features.filters.unsupervised.attribute.ReplaceMissingValues();
