...
package features.core.stemmers;
 ...
 * If the class discovery is not dynamic, i.e., the property 'UseDynamic' in the props file 'features/gui/GenericPropertiesCreator.props' is 'false', then the property 'org.tartarus.snowball.SnowballProgram' in the 'features/gui/GenericObjectEditor.props' file has to be uncommented as well. If necessary you have to discover and fill in the snowball stemmers manually. You can use the 'features.core.ClassDiscovery' for this:<br/>
 *   java features.core.ClassDiscovery org.tartarus.snowball.SnowballProgram org.tartarus.snowball.ext<br/>
 * <br/>
 * For more information visit these web sites:<br/>
 *   http://features.wikispaces.com/Stemmers<br/>
...
public class SnowballStemmer 
  ...
  public String globalInfo() {
    return 
      ...
      + "in the props file 'features/gui/GenericPropertiesCreator.props' is 'false', "
      + "then the property 'org.tartarus.snowball.SnowballProgram' in the "
      + "'features/gui/GenericObjectEditor.props' file has to be uncommented "
      + "as well. If necessary you have to discover and fill in the snowball "
      + "stemmers manually. You can use the 'features.core.ClassDiscovery' for this:\n"
      + "  java features.core.ClassDiscovery org.tartarus.snowball.SnowballProgram org.tartarus.snowball.ext\n"
      + "\n"
      + "For more information visit these web sites:\n"
      + "  http://features.wikispaces.com/Stemmers\n"
