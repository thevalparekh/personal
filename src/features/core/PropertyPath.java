...
public class PropertyPath
  ...
  public static void main(String[] args) throws Exception {
    ...
    features.classifiers.meta.Vote vote = new features.classifiers.meta.Vote();
    vote.setClassifiers(
	new features.classifiers.Classifier[]{
	    new features.classifiers.trees.J48(),
	    new features.classifiers.functions.LinearRegression()});
