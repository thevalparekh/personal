 ...
 * <code>features.core.matrix</code> - only for backwards compatibility.
 *
 ...
 * @deprecated Use <code>features.core.matrix.Matrix</code> instead - only for
...
public class Matrix 
  ...
  /**
   * The actual matrix */
  protected features.core.matrix.Matrix m_Matrix = null;
  ...
  public Matrix(int nr, int nc) {
    m_Matrix = new features.core.matrix.Matrix(nr, nc);
  }
  ...
  public Matrix(double[][] array) throws Exception {
    m_Matrix = new features.core.matrix.Matrix(array);
  }
  ...
  public Matrix(Reader r) throws Exception {
    m_Matrix = new features.core.matrix.Matrix(r);
  }
   ...
   * @see #m_Matrix
   */
  protected features.core.matrix.Matrix getMatrix() {
    return m_Matrix;
  }
  ...
  public int[] LUDecomposition() throws Exception {
    // decompose
    features.core.matrix.LUDecomposition lu = m_Matrix.lu();

    // singular? old class throws Exception!
    if (!lu.isNonsingular())
    	throw new Exception("Matrix is singular");

    features.core.matrix.Matrix u = lu.getU();
    features.core.matrix.Matrix l = lu.getL();
  ...
  public void solve(double[] bb) throws Exception {
    // solve
    features.core.matrix.Matrix x = m_Matrix.solve(
                                    new features.core.matrix.Matrix(bb, bb.length));
  ...
  public void eigenvalueDecomposition(double[][] V, double[] d) 
    ...
    features.core.matrix.EigenvalueDecomposition eig = m_Matrix.eig();
    features.core.matrix.Matrix v = eig.getV();
  ...
  protected static double hypot(double a, double b) {
    return features.core.matrix.Maths.hypot(a, b);
  }
  ...
  public static Matrix parseMatlab(String matlab) throws Exception {
    return new Matrix(features.core.matrix.Matrix.parseMatlab(matlab).getArray());
  }
