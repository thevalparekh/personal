...
package features.core.converters;
...
import features.core.ClassDiscovery;
...
public class ConverterUtils
  ...
  public final static String CORE_FILE_LOADERS = 
      features.core.converters.ArffLoader.class.getName() + ","
    + features.core.converters.C45Loader.class.getName() + ","
    + features.core.converters.CSVLoader.class.getName() + ","
    + features.core.converters.DatabaseConverter.class.getName() + ","
    + features.core.converters.LibSVMLoader.class.getName() + ","
    + features.core.converters.SerializedInstancesLoader.class.getName() + ","
    + features.core.converters.TextDirectoryLoader.class.getName() + ","
    + features.core.converters.XRFFLoader.class.getName();

  /** the core savers - hardcoded list necessary for RMI/Remote Experiments 
   * (comma-separated list). */
  public final static String CORE_FILE_SAVERS =
      features.core.converters.ArffSaver.class.getName() + ","
    + features.core.converters.C45Saver.class.getName() + ","
    + features.core.converters.CSVSaver.class.getName() + ","
    + features.core.converters.DatabaseConverter.class.getName() + ","
    + features.core.converters.LibSVMSaver.class.getName() + ","
    + features.core.converters.SerializedInstancesSaver.class.getName() + ","
    + features.core.converters.XRFFSaver.class.getName();
