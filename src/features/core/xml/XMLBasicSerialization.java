 ...
 * Weka classes:
 * <ul>
 *    <li>features.core.Matrix</li>
 *    <li>features.core.matrix.Matrix</li>
 * </ul>
 * 
...
public class XMLBasicSerialization
   ...
   public void clear() throws Exception {
      ...
      // Weka classes
      m_CustomMethods.register(this, features.core.matrix.Matrix.class, "Matrix");
      m_CustomMethods.register(this, features.core.Matrix.class, "MatrixOld");
      m_CustomMethods.register(this, features.classifiers.CostMatrix.class, "CostMatrixOld");
   }
    ...
    * @return the node that was created
    * @throws Exception if the DOM creation fails
    * @see features.core.matrix.Matrix
    */
   public Element writeMatrix(Element parent, Object o, String name) 
      throws Exception {

      features.core.matrix.Matrix    matrix;
      Element                    node;
      ...
      matrix = (features.core.matrix.Matrix) o;
      node   = addElement(parent, name, o.getClass().getName(), false);
   ...
   public Object readMatrix(Element node) throws Exception {
      ...
      for (i = 0; i < children.size(); i++) {
         ...
         if (name.equals(VAL_CELLS)) {
            ...
            matrix = new features.core.matrix.Matrix(
                        (double[][]) o);
         }
      }
   ...
   public Object readMatrixOld(Element node) throws Exception {
      features.core.Matrix           matrix;
      features.core.matrix.Matrix    matrixNew;
      ...
      matrixNew = (features.core.matrix.Matrix) readMatrix(node);
      matrix    = new features.core.Matrix(matrixNew.getArrayCopy());
    ...
    * @return the node that was created
    * @throws Exception if the DOM creation fails
    * @see features.classifiers.CostMatrix
    */
   ...
   public Object readCostMatrixOld(Element node) throws Exception {
      features.classifiers.CostMatrix   matrix;
      features.core.matrix.Matrix       matrixNew;
      StringWriter                  writer;
      ...
      matrix    = new features.classifiers.CostMatrix(new StringReader(writer.toString()));
