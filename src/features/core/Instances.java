...
public class Instances implements Serializable, RevisionHandler {
   ...
   *             instead.
   * @see features.core.converters.ArffLoader
   * @see features.core.converters.ConverterUtils.DataSource
   */
  // @ requires capacity >= 0;
  ...
  public AttributeStats attributeStats(int index) {
    ...
    if (attribute(index).isNumeric()) {
      result.numericStats = new features.experiment.Stats();
    }
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      // wrong parameters
        ...
        System.err.println("\nUsage:\n" + "\tfeatures.core.Instances help\n"
            + "\tfeatures.core.Instances <filename>\n"
            + "\tfeatures.core.Instances merge <filename1> <filename2>\n"
            + "\tfeatures.core.Instances append <filename1> <filename2>\n"
            + "\tfeatures.core.Instances headers <filename1> <filename2>\n"
            + "\tfeatures.core.Instances randomize <seed> <filename>\n");
      }
    } catch (Exception ex) {
      ex.printStackTrace();
