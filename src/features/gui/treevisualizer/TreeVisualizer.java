...
package features.gui.treevisualizer;
...
import features.gui.visualize.VisualizeUtils;
...
public class TreeVisualizer
  ...
  /** the props file. */
  public final static String PROPERTIES_FILE = "features/gui/treevisualizer/TreeVisualizer.props";
  ...
  public static void main(String[] args) {
    try {
      features.core.logging.Logger.log(features.core.logging.Logger.Level.INFO, Messages.getInstance().getString("TreeVisualizer_Main_Logger_Text"));
