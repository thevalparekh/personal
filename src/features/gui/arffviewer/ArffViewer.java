...
package features.gui.arffviewer;
...
import features.gui.ComponentHelper;
...
public class ArffViewer 
  ...
  public static void main(String[] args) throws Exception {
    features.core.logging.Logger.log(features.core.logging.Logger.Level.INFO, Messages.getInstance().getString("ArffViewer_Main_Logger_Text"));
