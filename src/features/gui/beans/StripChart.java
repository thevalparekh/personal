...
import features.gui.visualize.PrintableComponent;
...
public class StripChart
  ...
  private transient features.gui.Logger m_log = null;
  ...
  private static String numToString(double num) {
    ...
    String numString = features.core.Utils.doubleToString(num,
