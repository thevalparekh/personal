...
public class ClustererCustomizer
  ...
  private features.gui.beans.Clusterer m_dsClusterer;
  ...
  private features.clusterers.Clusterer m_backup;
  ...
  public void setObject(Object object) {
    m_dsClusterer = (features.gui.beans.Clusterer)object;
    try {
      m_backup = 
        (features.clusterers.Clusterer)GenericObjectEditor.makeCopy(m_dsClusterer.getClusterer());
    } catch (Exception ex) {
      // ignore
    }
