...
import features.core.converters.ArffSaver;
import features.core.converters.DatabaseConverter;
import features.core.converters.DatabaseSaver;


/**
 * Saves data sets using features.core.converter classes
 * 
...
public class Saver extends AbstractDataSink implements WekaWrapper,
   ...
   * Saver
   */
  private features.core.converters.Saver m_Saver = new ArffSaver();
  private features.core.converters.Saver m_SaverTemplate = m_Saver;
  ...
  private features.core.converters.Saver makeCopy() throws Exception {
    return (features.core.converters.Saver) new SerializedObject(m_SaverTemplate)
        .getObject();
  }
   ...
   * @param saver a Saver
   */
  public void setSaverTemplate(features.core.converters.Saver saver) {
  ...
  protected String sanitizeFilename(String filename) {
    ...
    filename = Utils.removeSubstring(filename,
        "features.filters.supervised.instance.");
    filename = Utils.removeSubstring(filename,
        "features.filters.supervised.attribute.");
    filename = Utils.removeSubstring(filename,
        "features.filters.unsupervised.instance.");
    filename = Utils.removeSubstring(filename,
        "features.filters.unsupervised.attribute.");
    filename = Utils.removeSubstring(filename, "features.clusterers.");
    filename = Utils.removeSubstring(filename, "features.associations.");
    filename = Utils.removeSubstring(filename, "features.attributeSelection.");
    filename = Utils.removeSubstring(filename, "features.estimators.");
    filename = Utils.removeSubstring(filename, "features.datagenerators.");
   ...
   * Get the saver
   * 
   * @return a <code>features.core.converters.Saver</code> value
   */
  public features.core.converters.Saver getSaverTemplate() {
  ...
  public void setWrappedAlgorithm(Object algorithm) {
    if (!(algorithm instanceof features.core.converters.Saver)) {
      throw new IllegalArgumentException(algorithm.getClass()
          + Messages.getInstance().getString(
              "Saver_SetWrappedAlgorithm_IllegalArgumentException_Text"));
    }
    setSaverTemplate((features.core.converters.Saver) algorithm);
  }
