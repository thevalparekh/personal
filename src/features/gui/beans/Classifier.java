...
import features.core.xml.KOML;
import features.core.xml.XStream;
import features.experiment.Task;
import features.experiment.TaskStatusInfo;
import features.gui.ExtensionFileFilter;
import features.gui.Logger;


/**
 * Bean that wraps around features.classifiers
 * 
...
public class Classifier extends JPanel implements BeanCommon, Visible,
  ...
  private features.classifiers.Classifier m_Classifier = new Trial1();
   ...
   * 
   * @param c a <code>features.classifiers.Classifier</code> value
   */
  public void setClassifierTemplate(features.classifiers.Classifier c) {
    ...
    if (!(m_ClassifierTemplate instanceof features.classifiers.UpdateableClassifier)
   ...
   * @return the classifier template currently in use.
   */
  public features.classifiers.Classifier getClassifierTemplate() {
    return m_ClassifierTemplate;
  }

  private void setTrainedClassifier(features.classifiers.Classifier tc)
      throws Exception {

    // set the template
    features.classifiers.Classifier newTemplate = null;

    String[] options = tc.getOptions();
    newTemplate = features.classifiers.Classifier.forName(tc.getClass().getName(),
        options);
   ...
   * 
   * @return a <code>features.classifiers.Classifier</code> value
   */
  public features.classifiers.Classifier getClassifier() {
    return m_Classifier;
  }
  ...
  public void setWrappedAlgorithm(Object algorithm) {
    ...
    if (!(algorithm instanceof features.classifiers.Classifier)) {
    ...
    setClassifierTemplate((features.classifiers.Classifier) algorithm);
  }
  ...
  private void handleIncrementalEvent() {
      ...
      try {
        ...
        if (m_trainingSet == null || (!dataset.equalHeaders(m_trainingSet))) {
          ...
          if (m_trainingSet == null) {
            ...
            m_Classifier = features.classifiers.Classifier
    ...
    try {
      ...
      if (m_ClassifierTemplate instanceof features.classifiers.UpdateableClassifier
        ...
        ((features.classifiers.UpdateableClassifier) m_Classifier)
    ...
    public void execute() {
      try {
        if (m_train != null) {
          ...
          features.classifiers.Classifier classifierCopy = features.classifiers.Classifier
              .makeCopy(m_ClassifierTemplate);
          ...
          if (classifierCopy instanceof features.core.Drawable
              && m_graphListeners.size() > 0) {
            String grphString = ((features.core.Drawable) classifierCopy).graph();
            int grphType = ((features.core.Drawable) classifierCopy).graphType();
  ...
  public boolean connectionAllowed(String eventName) {
     ...
     * features.classifiers.UpdateableClassifier)) { return false; } }
     */
  ...
  public void loadModel() {
    try {
      ...
      if (returnVal == JFileChooser.APPROVE_OPTION) {
        ...
        features.classifiers.Classifier temp = null;
        ...
        if ((KOML.isPresent())
          ...
          temp = (features.classifiers.Classifier) v.elementAt(0);
          if (v.size() == 2) {
          ...
          temp = (features.classifiers.Classifier) is.readObject();
  ...
  public boolean eventGeneratable(String eventName) {
    ...
    if (eventName.compareTo("graph") == 0) {
      ...
      if (!(m_ClassifierTemplate instanceof features.core.Drawable)) {
        return false;
      }
    ...
    if (eventName.compareTo("incrementalClassifier") == 0) {
      /*
       * if (!(m_Classifier instanceof features.classifiers.UpdateableClassifier)) {
       * return false; }
       */
      if (!m_listenees.containsKey("instance")) {
        return false;
