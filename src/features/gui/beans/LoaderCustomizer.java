...
import features.gui.PropertySheetPanel;
...
public class LoaderCustomizer
  ...
  private features.gui.beans.Loader m_dsLoader;
  ...
  public LoaderCustomizer() {
    ...
    try {
      /*      m_LoaderEditor.setClassType(features.core.converters.Loader.class);
	      m_LoaderEditor.setValue(new features.core.converters.ArffLoader()); */
   ...
   *
   * @param object a features.gui.beans.Loader
   */
  public void setObject(Object object) {
    m_dsLoader = (features.gui.beans.Loader)object;
