...
import features.filters.StreamableFilter;
...
public class Filter
   ...
   * The filter to use.
   */
  private features.filters.Filter m_Filter = new AllFilter();
  ...
  public features.filters.Filter getFilter() {
    return m_Filter;
  }
   ...
   * Set the filter to be wrapped by this bean
   *
   * @param algorithm a features.filters.Filter
   * @exception IllegalArgumentException if an error occurs
   */
  public void setWrappedAlgorithm(Object algorithm) {
    
    if (!(algorithm instanceof features.filters.Filter)) { 
    ...
    setFilter((features.filters.Filter)algorithm);
  }
...
//		    m_visual.setText("Filtering training data...");
		    ...
		    Instances filteredData = 
		      features.filters.Filter.useFilter(m_trainingSet, m_Filter);
//		    m_visual.setText(oldText);
		    m_visual.setStatic();
		    EventObject ne;
		    if (e instanceof TrainingSetEvent) {
		      ne = new TrainingSetEvent(features.gui.beans.Filter.this, 
						filteredData);
			...
			((TrainingSetEvent)e).m_maxSetNumber;
		      ...
		      ne = new DataSetEvent(features.gui.beans.Filter.this,
					    filteredData);
		    }
  ...
  public void acceptTestSet(final TestSetEvent e) {
	...
	m_filterThread = new Thread() {
		...
		if (m_testingSet != null) {
		  ...
		  m_visual.setStatic();
		  TestSetEvent ne =
		    new TestSetEvent(features.gui.beans.Filter.this,
				     filteredTest);
