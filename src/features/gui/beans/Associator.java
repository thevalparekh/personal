...
import features.associations.Apriori;
...
/**
 * Bean that wraps around features.associations
 *
...
public class Associator
  ...
  private features.associations.Associator m_Associator = new Apriori();
   ...
   *
   * @param c a <code>features.associations.Associator</code> value
   */
  public void setAssociator(features.associations.Associator c) {
   ...
   *
   * @return a <code>features.associations.Associator</code> value
   */
  public features.associations.Associator getAssociator() {
    return m_Associator;
  }
  ...
  public void setWrappedAlgorithm(Object algorithm) {
    ...
    if (!(algorithm instanceof features.associations.Associator)) { 
    ...
    setAssociator((features.associations.Associator)algorithm);
  }
...
//		    m_visual.setText("Building model...");
			...
			substring(titleString.lastIndexOf('.') + 1,
		      ...
		      notifyTextListeners(nt);
                    ...
                    if (m_Associator instanceof features.core.Drawable && 
			m_graphListeners.size() > 0) {
		      String grphString = 
			((features.core.Drawable)m_Associator).graph();
                      int grphType = ((features.core.Drawable)m_Associator).graphType();
  ...
  public boolean eventGeneratable(String eventName) {
	...
	if (!((EventConstraints)source).eventGeneratable("dataSet")) {
      ...
      if (eventName.compareTo("graph") == 0 &&
          !(m_Associator instanceof features.core.Drawable)) {
        return false;
      }
    }
    return true;
