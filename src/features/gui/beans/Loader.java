...
import features.core.converters.ArffLoader;
import features.core.converters.DatabaseLoader;
import features.core.converters.FileSourcedConverter;
import features.gui.Logger;

/**
 * Loads data sets using features.core.converter classes
 *
...
public class Loader
   ...
   * Loader
   */
  private features.core.converters.Loader m_Loader = new ArffLoader();
...
//        m_visual.setText("Loading...");
	...
	if (instanceGeneration) {
	  ...
	  try {
            m_Loader.reset();
            m_Loader.setRetrieval(features.core.converters.Loader.INCREMENTAL);
...
//	  m_visual.setText(structure.relationName());
          ...
          m_Loader.reset();
          m_Loader.setRetrieval(features.core.converters.Loader.BATCH);
...
//	  m_visual.setText(m_dataSet.relationName());
   ...
   *
   * @param loader a <code>features.core.converters.Loader</code> value
   */
  public void setLoader(features.core.converters.Loader loader) {
...
//    notifyStructureAvailable(m_dataFormat);
   ...
   * Get the loader
   *
   * @return a <code>features.core.converters.Loader</code> value
   */
  public features.core.converters.Loader getLoader() {
    return m_Loader;
  }
  ...
  public void setWrappedAlgorithm(Object algorithm) 
    ...
    if (!(algorithm instanceof features.core.converters.Loader)) { 
    ...
    setLoader((features.core.converters.Loader)algorithm);
  }
  ...
  public boolean eventGeneratable(String eventName) {
    if (eventName.compareTo("instance") == 0) {
      if (!(m_Loader instanceof features.core.converters.IncrementalConverter)) {
	return false;
      }
      if (m_dataSetEventTargets > 0) {
	return false;
    ...
    if (eventName.compareTo("dataSet") == 0) {
      if (!(m_Loader instanceof features.core.converters.BatchConverter)) {
	return false;
      }
   ...
   * Set a logger
   *
   * @param logger a <code>features.gui.Logger</code> value
   */
