...
/**
 * Bean that wraps around features.clusterers
 *
...
public class Clusterer
  ...
  private features.clusterers.Clusterer m_Clusterer = new EM();
   ...
   *
   * @param c a <code>features.clusterers.Clusterer</code> value
   */
  public void setClusterer(features.clusterers.Clusterer c) {
   ...
   *
   * @return a <code>features.clusterers.Clusterer</code> value
   */
  public features.clusterers.Clusterer getClusterer() {
    return m_Clusterer;
  }
  ...
  public void setWrappedAlgorithm(Object algorithm) 
    ...
    if (!(algorithm instanceof features.clusterers.Clusterer)) { 
    ...
    setClusterer((features.clusterers.Clusterer)algorithm);
  }
...
//		    m_visual.setText("Building clusters...");
		    ...
		    if (m_Clusterer instanceof features.core.Drawable && 
			m_graphListeners.size() > 0) {
		      String grphString = 
			((features.core.Drawable)m_Clusterer).graph();
                      int grphType = ((features.core.Drawable)m_Clusterer).graphType();
...
/**
  ...
  public boolean connectionAllowed(String eventName) {
    /*    if (eventName.compareTo("instance") == 0) {
      if (!(m_Clusterer instanceof features.classifiers.UpdateableClassifier)) {
	return false;
      }
      } */
  ...
  public void loadModel() {
    try {
      ...
      if (returnVal == JFileChooser.APPROVE_OPTION) {
        ...
        features.clusterers.Clusterer temp = (features.clusterers.Clusterer)is.readObject();
