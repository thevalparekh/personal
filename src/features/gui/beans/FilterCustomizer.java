...
/*  private GenericObjectEditor m_filterEditor = 
  ...
  public void setObject(Object object) {
    m_filter = (features.gui.beans.Filter)object;
    try {
      m_backup = 
        (features.filters.Filter)GenericObjectEditor.makeCopy(m_filter.getFilter());
    } catch (Exception ex) {
      // ignore
    }
