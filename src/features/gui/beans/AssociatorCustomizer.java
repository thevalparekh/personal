...
public class AssociatorCustomizer
  ...
  private features.gui.beans.Associator m_dsAssociator;
  ...
  private features.associations.Associator m_backup;
  ...
  public void setObject(Object object) {
    m_dsAssociator = (features.gui.beans.Associator)object;
    //    System.err.println(Utils.joinOptions(((OptionHandler)m_dsClassifier.getClassifier()).getOptions()));
    try {
      m_backup = 
        (features.associations.Associator)GenericObjectEditor.makeCopy(m_dsAssociator.getAssociator());
    } catch (Exception ex) {
      // ignore
    }
