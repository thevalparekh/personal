...
//      double totalInstances = 
  ...
  public static void main(String[] args) {
    try {
      ...
      features.classifiers.evaluation.ThresholdCurve tc = 
        new features.classifiers.evaluation.ThresholdCurve();
      features.classifiers.evaluation.EvaluationUtils eu = 
        new features.classifiers.evaluation.EvaluationUtils();
      //features.classifiers.Classifier classifier = new features.classifiers.functions.Logistic();
      features.classifiers.Classifier classifier = new features.classifiers.bayes.NaiveBayes();
