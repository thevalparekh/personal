...
public class ClassifierCustomizer
  ...
  private features.gui.beans.Classifier m_dsClassifier;
  ...
  protected features.classifiers.Classifier m_backup;
  ...
  private void checkOnClassifierType() {
    ...
    if (editedC instanceof features.classifiers.UpdateableClassifier && 
  ...
  public void setObject(Object object) {
    m_dsClassifier = (features.gui.beans.Classifier)object;
    //    System.err.println(Utils.joinOptions(((OptionHandler)m_dsClassifier.getClassifier()).getOptions()));
    try {
      m_backup = 
        (features.classifiers.Classifier)GenericObjectEditor.makeCopy(m_dsClassifier.getClassifierTemplate());
    } catch (Exception ex) {
      // ignore
    }
  ...
  /* (non-Javadoc)
   * @see features.gui.beans.CustomizerClosingListener#customizerClosing()
   */
