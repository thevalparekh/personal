...
package features.gui.beans.xml;
...
import features.core.Environment;
import features.core.EnvironmentHandler;
import features.core.converters.ConverterUtils;
import features.core.xml.XMLBasicSerialization;
import features.core.xml.XMLDocument;
import features.gui.beans.BeanCommon;
import features.gui.beans.BeanConnection;
import features.gui.beans.BeanInstance;
import features.gui.beans.BeanVisual;
import features.gui.beans.MetaBean;
import features.gui.beans.Visible;
...
public class XMLBeans 
  ...
  * (Instances and Connections are stored in a Vector and then serialized) */
  ...
  public void clear() throws Exception {
    ...
    // allow
    m_Properties.addAllowed(features.gui.beans.BeanInstance.class, "x");
    m_Properties.addAllowed(features.gui.beans.BeanInstance.class, "y");
    m_Properties.addAllowed(features.gui.beans.BeanInstance.class, "bean");
    m_Properties.addAllowed(features.gui.beans.Saver.class, "wrappedAlgorithm");
    m_Properties.addAllowed(features.gui.beans.Loader.class, "wrappedAlgorithm");
    m_Properties.addAllowed(features.gui.beans.Saver.class, "relationNameForFilename");
    if (getDataType() == DATATYPE_LAYOUT)
      m_Properties.addAllowed(features.gui.beans.Loader.class, "beanContext");
    else
      m_Properties.addIgnored(features.gui.beans.Loader.class, "beanContext");   // TODO: more classes???
    m_Properties.addAllowed(features.gui.beans.Filter.class, "filter");
    m_Properties.addAllowed(features.gui.beans.Associator.class, "associator");
    m_Properties.addAllowed(features.gui.beans.Classifier.class, "wrappedAlgorithm");
    m_Properties.addAllowed(features.gui.beans.Clusterer.class, "wrappedAlgorithm");
    m_Properties.addAllowed(features.gui.beans.Classifier.class, "executionSlots");

    m_Properties.addAllowed(features.classifiers.Classifier.class, "debug");
    m_Properties.addAllowed(features.classifiers.Classifier.class, "options");
    m_Properties.addAllowed(features.filters.Filter.class, "options");
    m_Properties.addAllowed(features.associations.Associator.class, "options");
    m_Properties.addAllowed(features.clusterers.Clusterer.class, "options");
    
    m_Properties.addAllowed(features.core.converters.DatabaseSaver.class, "options");
    m_Properties.addAllowed(features.core.converters.DatabaseLoader.class, "options");
    m_Properties.addAllowed(features.core.converters.TextDirectoryLoader.class, "options");

    // we assume that classes implementing SplitEvaluator also implement OptionHandler
    m_Properties.addAllowed(features.experiment.SplitEvaluator.class, "options");
    // we assume that classes implementing ResultProducer also implement OptionHandler
    m_Properties.addAllowed(features.experiment.ResultProducer.class, "options");
    ...
    m_CustomMethods.register(this, features.gui.beans.BeanInstance.class, "BeanInstance");
    m_CustomMethods.register(this, features.gui.beans.BeanConnection.class, "BeanConnection");
    m_CustomMethods.register(this, features.gui.beans.BeanVisual.class, "BeanVisual");
    m_CustomMethods.register(this, features.gui.beans.Saver.class, "BeanSaver");
    m_CustomMethods.register(this, features.gui.beans.MetaBean.class, "MetaBean");
  ...
  public Object readBeanInstance(Element node) throws Exception {
    ...
    if (beaninst.getBean() instanceof features.gui.beans.Visible) {
  ...
  public Element writeBeanLoader(Element parent, Object o, String name)
    ...
    Element                 node;
    features.gui.beans.Loader   loader;
    ...
    loader = (features.gui.beans.Loader) o;
  ...
  public Element writeBeanSaver(Element parent, Object o, String name)
    ...
    Element                 node;
    features.gui.beans.Saver    saver;
    ...
    saver = (features.gui.beans.Saver) o;
  ...
  public Element writeLoader(Element parent, Object o, String name)
    ...
    Element                       node;
    features.core.converters.Loader   loader;
    File                          file;
    boolean                       known;
    ...
    loader = (features.core.converters.Loader) o;
    node   = addElement(parent, name, loader.getClass().getName(), false);
    known  = true;
    file   = null;

    // file
    if (loader instanceof features.core.converters.AbstractFileLoader)
      file = ((features.core.converters.AbstractFileLoader) loader).retrieveFile();
    else
      known = false;
    ...
    if (loader instanceof features.core.converters.FileSourcedConverter) {
      boolean relative = ((features.core.converters.FileSourcedConverter)loader).getUseRelativePath();
    ...
    if ( (file == null) || (file.isDirectory()) ) {
      ...
      boolean notAbsolute = 
        (((features.core.converters.AbstractFileLoader) loader).getUseRelativePath() ||
  ...
  public Object readLoader(Element node) throws Exception {
    ...
    if (result instanceof features.core.converters.FileSourcedConverter) {
      ((features.core.converters.FileSourcedConverter)result).setUseRelativePath(relative);
    }
    ...
    if (file != null) {
      ...
      if (containsEnv || fl.exists()) {
        ((features.core.converters.AbstractFileLoader) result).setSource(new File(file));
      } else {
  ...
  public Element writeSaver(Element parent, Object o, String name)
    ...
    Element                     node;
    features.core.converters.Saver  saver;
    File                        file;
    String			prefix;
    String			dir;
    boolean                     known;
    ...
    saver  = (features.core.converters.Saver) o;
    node   = addElement(parent, name, saver.getClass().getName(), false);
    known  = true;
    file   = null;
    prefix = "";
    ...
    // file
    if (saver instanceof features.core.converters.AbstractFileSaver) {
      file   = ((features.core.converters.AbstractFileSaver) saver).retrieveFile();
      prefix = ((features.core.converters.AbstractFileSaver) saver).filePrefix();
      dir    = ((features.core.converters.AbstractFileSaver) saver).retrieveDir();
      // Replace any windows file separators with forward slashes (Java under windows can
      // read paths with forward slashes (apparantly)
      dir = dir.replace('\\', '/');
    }
    ...
    Boolean relativeB = null;
    if (saver instanceof features.core.converters.FileSourcedConverter) {
      boolean relative = ((features.core.converters.FileSourcedConverter)saver).getUseRelativePath();
      relativeB = new Boolean(relative);
    }
...
/*    }
      ...
      String path = (((features.core.converters.FileSourcedConverter) saver).getUseRelativePath())
        ? file.getPath()
        : file.getAbsolutePath();
      // Replace any windows file separators with forward slashes (Java under windows can
      // read paths with forward slashes (apparantly)
  ...
  public Object readSaver(Element node) throws Exception {
    ...
    if ( (dir != null) && (prefix != null) ) {
      ((features.core.converters.AbstractFileSaver) result).setDir(dir);
      ((features.core.converters.AbstractFileSaver) result).setFilePrefix(prefix);
    }
