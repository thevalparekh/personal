...
import features.gui.CheckBoxList.CheckBoxListModel;
...
public class GenericObjectEditor implements PropertyEditor, CustomPanelSupplier {
  ...
  public static final String GUIEDITORS_PROPERTY_FILE = "features/gui/GUIEditors.props";
  ...
  /**
   * registers all the editors in features.
   */
   ...
   * "features." as the prefix for all classes the a hashtable of size 1 is returned. 
  ...
  public static void main(String [] args) {
    ...
    try {
      ...
      Object initial = new features.classifiers.rules.ZeroR();
      if (args.length > 0){
