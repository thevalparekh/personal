...
package features.gui.boundaryvisualizer;
...
import features.gui.visualize.ClassPanel;
...
//			plotTrainingData();
    ...
    m_classifierEditor.setClassType(features.classifiers.Classifier.class);
    ...
    features.gui.PropertySheetPanel psp = new features.gui.PropertySheetPanel();
...
//     if (m_IOThread == null) {
  ...
  */
  ...
  public static void main(String [] args) {
    features.core.logging.Logger.log(features.core.logging.Logger.Level.INFO, Messages.getInstance().getString("BoundaryVisualizer_Main_Logger_Text"));
    try {
    	if (args.length < 2) {
