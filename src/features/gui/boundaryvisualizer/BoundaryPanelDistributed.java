...
import features.experiment.Compute;
import features.experiment.RemoteExperimentEvent;
import features.experiment.RemoteExperimentListener;
...
public class BoundaryPanelDistributed
  ...
  private features.core.Queue m_remoteHostsQueue = new features.core.Queue();
  ...
  private features.core.Queue m_subExpQueue = new features.core.Queue();
  ...
  protected void initialize() {
    ...
    m_remoteHostsQueue = new features.core.Queue();
    ...
    m_subExpQueue = new features.core.Queue();
