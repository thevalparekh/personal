 ...
 *
 */
package features.gui.graphvisualizer;
 ...
 * be sufficient to use only this class in features.gui.graphvisulizer
...
public class GraphVisualizer
  ...
  /** path for icons */
  private final String ICONPATH = "features/gui/graphvisualizer/icons/";
  ...
  public static void main(String [] args) {
    features.core.logging.Logger.log(features.core.logging.Logger.Level.INFO, Messages.getInstance().getString("GraphVisualizer_Main_Logger_Text"));
