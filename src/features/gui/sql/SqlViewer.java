...
import features.gui.sql.event.ConnectionEvent;
import features.gui.sql.event.ConnectionListener;
import features.gui.sql.event.HistoryChangedEvent;
import features.gui.sql.event.HistoryChangedListener;
import features.gui.sql.event.QueryExecuteEvent;
import features.gui.sql.event.QueryExecuteListener;
import features.gui.sql.event.ResultChangedEvent;
import features.gui.sql.event.ResultChangedListener;
...
public class SqlViewer 
  ...
  public static void main(String[] args) {
    features.core.logging.Logger.log(features.core.logging.Logger.Level.INFO, Messages.getInstance().getString("SqlViewer_Main_Log_Text"));
