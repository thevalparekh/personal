...
public class VisualizeUtils {
  ...
  protected static String PROPERTY_FILE = "features/gui/visualize/Visualize.props";
  ...
  static {
    ...
    try {
      ...
      String precision = 
	VISUALIZE_PROPERTIES.getProperty("features.gui.visualize.precision");
      if (precision == null) {
	/*
	System.err.println("Warning: no configuration property found in"
			   +PROPERTY_FILE
			   +" for features.gui.visualize.precision. Using"
			   +" default instead.");*/
      } else {
