...
public class Experimenter
  ...
  public static void main(String [] args) {
    features.core.logging.Logger.log(features.core.logging.Logger.Level.INFO, Messages.getInstance().getString("Experimenter_Main_LoggingStarted_Text"));    
	...
	public void windowClosing(WindowEvent e) {
      ...
      Image icon = Toolkit.getDefaultToolkit().
        getImage(m_experimenter.getClass().getClassLoader().getResource("features/gui/weka_icon_new_48.png"));
