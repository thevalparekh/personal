...
public class ComponentHelper {
  ...
  public final static String[] IMAGES = {"features/gui/", "features/gui/images/"};
  ...
  public static int showMessageBox(Component parent, String title, String msg, int buttons, int messageType) { 
    ...
    switch (messageType) {
      ...
      icon = "features/gui/images/error.gif";
      break;
    case JOptionPane.INFORMATION_MESSAGE:
      icon = "features/gui/images/information.gif";
      break;
    case JOptionPane.WARNING_MESSAGE:
      icon = "features/gui/images/information.gif";
      break;
    case JOptionPane.QUESTION_MESSAGE:
      icon = "features/gui/images/question.gif";
      break;
    default:
      icon = "features/gui/images/information.gif";
      break;
