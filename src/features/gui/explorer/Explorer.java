...
import features.gui.LogPanel;
import features.gui.Logger;
import features.gui.LookAndFeel;
import features.gui.WekaTaskMonitor;
...
public class Explorer
  ...
  public static void main(String [] args) {
    ...
    features.core.logging.Logger.log(features.core.logging.Logger.Level.INFO, Messages.getInstance().getString("Explorer_Main_Logger_Text"));
    ...
    try {
      ...
      Image icon = Toolkit.getDefaultToolkit().
        getImage(m_explorer.getClass().getClassLoader().getResource("features/gui/weka_icon_new_48.png"));
