...
public class ExplorerDefaults
   ...
   * 
   * @return		the default classifier, Trial1 by default
   */
  public static Object getClassifier() {
    ...
    result = getObject(
		...
		//features.classifiers.rules.Trial1.class.getName(), 
		features.classifiers.Classifier.class);
    if (result == null)
      result = new features.classifiers.bayes.NaiveBayes();//new features.classifiers.rules.Trial1();
