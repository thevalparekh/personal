 ...
 * the props file <code>features/gui/explorer/Explorer.props</code>.
 *
...
public class ExplorerDefaults
  ...
  public final static String PROPERTY_FILE = "features/gui/explorer/Explorer.props";
  ...
  public static String[] getTabs() {
    ...
    tabs   = get("Tabs", "features.gui.explorer.ClassifierPanel,features.gui.explorer.ClustererPanel,features.gui.explorer.AssociationsPanel,features.gui.explorer.AttributeSelectionPanel,features.gui.explorer.VisualizePanel");
    result = tabs.split(",");
  ...
  public static Object getFilter() {
    return getObject("Filter", "", features.filters.Filter.class);
  }
  ...
  public static Object getClassifier() {
    ...
    if (result == null)
      result = new features.classifiers.rules.ZeroR();
  ...
  public static Object getClusterer() {
    ...
    result = getObject(
		"Clusterer", 
		features.clusterers.EM.class.getName(), 
		features.clusterers.Clusterer.class);
    if (result == null)
      result = new features.clusterers.EM();
  ...
  public static Object getAssociator() {
    ...
    result = getObject(
		"Associator", 
		features.associations.Apriori.class.getName(), 
		features.associations.Associator.class);
    if (result == null)
      result = new features.associations.Apriori();
  ...
  public static Object getASEvaluator() {
    ...
    result = getObject(
		"ASEvaluation", 
		features.attributeSelection.CfsSubsetEval.class.getName(), 
		features.attributeSelection.ASEvaluation.class);
    if (result == null)
      result = new features.attributeSelection.CfsSubsetEval();
  ...
  public static Object getASSearch() {
    ...
    result = getObject(
		"ASSearch", 
		features.attributeSelection.BestFirst.class.getName(), 
		features.attributeSelection.ASSearch.class);
    if (result == null)
      result = new features.attributeSelection.BestFirst();
