 ...
 *  eg: features.experiment.CrossValidationResultProducer</pre>
 * 
 * <pre> 
 * Options specific to result producer features.experiment.AveragingResultProducer:
 * </pre>
 * 
 * <pre> -F &lt;field name&gt;
 ...
 * 
 * <pre> 
 * Options specific to result producer features.experiment.CrossValidationResultProducer:
 * </pre>
 * 
...
public class LearningRateResultProducer 
  ...
  public Enumeration listOptions() {
    ...
    newVector.addElement(new Option(
	     "\tThe full class name of a ResultProducer.\n"
	      +"\teg: features.experiment.CrossValidationResultProducer", 
	     "W", 1, 
	     "-W <class name>"));
