...
import features.experiment.xml.XMLExperiment;
 ...
 * features.experiment.RemoteExperiment -L 1 -U 10 \
 * -T /home/ml/datasets/UCI/iris.arff \
 * -D "features.experiment.DatabaseResultListener" \
 * -P "features.experiment.RandomSplitResultProducer" \
 * -h rosebud.cs.waikato.ac.nz -h blackbird.cs.waikato.ac.nz -r -- \
 * -W features.experiment.ClassifierSplitEvaluator -- \
 * -W features.classifiers.bayes.NaiveBayes
 *
 * </pre> <p>
 ...
 *  eg: features.experiment.RandomSplitResultProducer</pre>
 * 
 * <pre> -D &lt;class name&gt;
 *  The full class name of a ResultListener (required).
 *  eg: features.experiment.CSVResultListener</pre>
 * 
 * <pre> -N &lt;string&gt;
 ...
 * 
 * <pre> 
 * Options specific to result producer features.experiment.RandomSplitResultProducer:
 * </pre>
 * 
 * <pre> -P &lt;percent&gt;
 ...
 *  eg: features.experiment.ClassifierSplitEvaluator</pre>
 * 
 * <pre> -R
 ...
 * 
 * <pre> 
 * Options specific to split evaluator features.experiment.ClassifierSplitEvaluator:
 * </pre>
 * 
 * <pre> -W &lt;class name&gt;
