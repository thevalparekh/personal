 ...
 * clusterers. If you implement a clusterer using the features.libraries,
 ...
 * 
 * Typical usage: <p/>
 * <code>java features.clusterers.CheckClusterer -W clusterer_name 
 ...
 *
 * The <code>features.clusterers.AbstractClustererTest</code> uses this
 ...
 *  eg: features.clusterers.SimpleKMeans
 *  (default features.clusterers.SimpleKMeans)</pre>
 * 
 * <pre> 
 * Options specific to clusterer features.clusterers.SimpleKMeans:
 * </pre>
 * 
 * <pre> -N &lt;num&gt;
 *  number of clusters.
...
public class CheckClusterer 
  ...
  public Enumeration listOptions() {
    ...
    result.addElement(new Option(
        "\tFull name of the clusterer analyzed.\n"
        +"\teg: features.clusterers.SimpleKMeans\n"
        + "\t(default features.clusterers.SimpleKMeans)",
        "W", 1, "-W"));
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    if (tmpStr.length() == 0)
      tmpStr = features.clusterers.SimpleKMeans.class.getName();
    setClusterer(
	(Clusterer) forName(
	    "features.clusterers", 
	    Clusterer.class, 
