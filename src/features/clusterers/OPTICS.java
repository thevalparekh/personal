...
import features.clusterers.forOPTICSAndDBScan.DataObjects.DataObject;
import features.clusterers.forOPTICSAndDBScan.Databases.Database;
import features.clusterers.forOPTICSAndDBScan.OPTICS_GUI.OPTICS_Visualizer;
import features.clusterers.forOPTICSAndDBScan.OPTICS_GUI.SERObject;
import features.clusterers.forOPTICSAndDBScan.Utils.EpsilonRange_ListElement;
import features.clusterers.forOPTICSAndDBScan.Utils.UpdateQueue;
import features.clusterers.forOPTICSAndDBScan.Utils.UpdateQueueElement;
...
import features.core.TechnicalInformation;
import features.core.TechnicalInformationHandler;
import features.core.Utils;
import features.core.Capabilities.Capability;
import features.core.TechnicalInformation.Field;
import features.core.TechnicalInformation.Type;
import features.filters.Filter;
import features.filters.unsupervised.attribute.ReplaceMissingValues;
 ...
 * 
 * <pre> -I &lt;String&gt;
 *  index (database) used for OPTICS (default = features.clusterers.forOPTICSAndDBScan.Databases.SequentialDatabase)</pre>
 * 
 * <pre> -D &lt;String&gt;
 *  distance-type (default = features.clusterers.forOPTICSAndDBScan.DataObjects.EuclideanDataObject)</pre>
 * 
 * <pre> -F
 ...
 *    java features.clusterers.forOPTICSAndDBScan.OPTICS_GUI.OPTICS_Visualizer [file.ser]
 *  (default: .)</pre>
 * 
 <!-- options-end -->
 *
...
public class OPTICS 
     ...
     * (default = features.clusterers.forOPTICSAndDBScan.DataObjects.EuclideanDataObject)
     */
    private String database_distanceType = "features.clusterers.forOPTICSAndDBScan.DataObjects.EuclideanDataObject";

    /**
     * Holds the type of the used database
     * (default = features.clusterers.forOPTICSAndDBScan.Databases.SequentialDatabase)
     */
    private String database_Type = "features.clusterers.forOPTICSAndDBScan.Databases.SequentialDatabase";
    ...
    public Enumeration listOptions() {
        ...
        vector.addElement(
            new Option(
        	"\tindex (database) used for OPTICS (default = features.clusterers.forOPTICSAndDBScan.Databases.SequentialDatabase)",
        	"I", 1, "-I <String>"));
        
        vector.addElement(
            new Option(
        	"\tdistance-type (default = features.clusterers.forOPTICSAndDBScan.DataObjects.EuclideanDataObject)",
        	"D", 1, "-D <String>"));
    ...
    public void setOptions(String[] options) throws Exception {
        ...
        if (optionString.length() != 0)
            ...
            setDatabase_Type(features.clusterers.forOPTICSAndDBScan.Databases.SequentialDatabase.class.getName());

        optionString = Utils.getOption('D', options);
        if (optionString.length() != 0)
            setDatabase_distanceType(optionString);
        else
            setDatabase_distanceType(features.clusterers.forOPTICSAndDBScan.DataObjects.EuclideanDataObject.class.getName());
     ...
     *                                   'I' index-type (default = features.clusterers.forOPTICSAndDBScan.Databases.SequentialDatabase);
     *                                   'D' distance-type (default = features.clusterers.forOPTICSAndDBScan.DataObjects.EuclideanDataObject);
