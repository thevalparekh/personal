 ...
 * 
 * <pre> -I &lt;String&gt;
 *  index (database) used for DBSCAN (default = features.clusterers.forOPTICSAndDBScan.Databases.SequentialDatabase)</pre>
 * 
 * <pre> -D &lt;String&gt;
    ...
    public Enumeration listOptions() {
        ...
        vector.addElement(
                new Option("\tminPoints (default = 6)",
                        ...
                        "-M <int>"));
        vector.addElement(
                new Option("\tindex (database) used for DBSCAN (default = features.clusterers.forOPTICSAndDBScan.Databases.SequentialDatabase)",
                        "I",
                        1,
                        "-I <String>"));
        vector.addElement(
                new Option("\tdistance-type (default = features.clusterers.forOPTICSAndDBScan.DataObjects.EuclideanDataObject)",
                        "D",
                        1,
                        "-D <String>"));
