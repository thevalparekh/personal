 ...
 * (default: features.filters.AllFilter)</pre>
 * 
 * <pre> -W
 ...
 * @see features.classifiers.meta.FilteredClassifier
 */
public class FilteredClusterer
  ...
  public FilteredClusterer() {
    ...
    m_Filter    = new features.filters.AllFilter();
  }
  ...
  protected String defaultFilterString() {
    return features.filters.AllFilter.class.getName();
  }
  ...
  public void setOptions(String[] options) throws Exception {
	...
	throw new IllegalArgumentException("Invalid filter specification string");
      ...
      setFilter(new features.filters.AllFilter());
    }
