...
package features.classifiers.pmml.consumer;
...
public class GeneralRegression extends PMMLClassifier
  ...
  enum CumulativeLinkFunction {
    ...
    PROBIT ("probit") {
      double eval(double value, double offset) {
        return features.core.matrix.Maths.pnorm(value + offset); 
      }
    },
    CLOGLOG ("cloglog") {
      double eval(double value, double offset) {
  ...
  enum LinkFunction {
    ...
    PROBIT ("probit") {
      double eval(double value, double offset, double trials,
                  double distParam, double linkParam) {
        return features.core.matrix.Maths.pnorm(value + offset) * trials;
      }
    };
  ...
  /* (non-Javadoc)
   * @see features.core.RevisionHandler#getRevision()
   */
