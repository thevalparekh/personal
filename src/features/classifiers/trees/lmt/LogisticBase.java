 ...
 * Used for building logistic model trees (features.classifiers.trees.lmt.LMT)
 * and standalone logistic regression (features.classifiers.functions.SimpleLogistic).
 *
 <!-- options-start -->
 * Valid options are: <p/>
 * 
