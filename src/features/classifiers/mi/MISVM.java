...
import features.classifiers.functions.SMO;
...
import features.filters.unsupervised.instance.SparseToNonSparse;


/**
 <!-- globalinfo-start -->
 * Implements Stuart Andrews' mi_SVM (Maximum pattern Margin Formulation of MIL). Applying features.classifiers.functions.SMO to solve multiple instances problem.<br/>
 ...
 * @see features.classifiers.functions.SMO
 */
public class MISVM 
  extends Classifier 
  ...
  public String globalInfo() {
    return 
       ...
       + "Formulation of MIL). Applying features.classifiers.functions.SMO "
