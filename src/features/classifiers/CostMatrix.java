...
import features.core.AttributeExpression;
...
public class CostMatrix implements Serializable, RevisionHandler {
   ...
   * matrix. (FracPete: taken from old features.core.Matrix class)
   * 
   ...
   * constructor. (FracPete: taken from old features.core.Matrix class)
   * 
  ...
  /**
   * Converts a matrix to a string. (FracPete: taken from old features.core.Matrix
   * class)
   * 
