...
public class StackingC 
   ...
   */
  public StackingC() {
    m_MetaClassifier = new features.classifiers.functions.LinearRegression();
    ((LinearRegression)(getMetaClassifier())).
      setAttributeSelectionMethod(new 
	features.core.SelectedTag(1, LinearRegression.TAGS_SELECTION));
  }  
  ...
  protected void generateMetaLevel(Instances newData, Random random) 
	...
	arrIdc[j] = m_BaseFormat.numClasses() * j + i;
      ...
      m_makeIndicatorFilter = new features.filters.unsupervised.attribute.MakeIndicator();
      ...
      m_attrFilter = new features.filters.unsupervised.attribute.Remove();
