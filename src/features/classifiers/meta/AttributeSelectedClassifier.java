 ...
 *  by its options.
 *  eg: "features.attributeSelection.CfsSubsetEval -L"
 *  (default features.attributeSelection.CfsSubsetEval)</pre>
 * 
...
public class AttributeSelectedClassifier 
  ...
  protected ASEvaluation m_Evaluator = 
    new features.attributeSelection.CfsSubsetEval();

  /** The search method to use */
  protected ASSearch m_Search = new features.attributeSelection.BestFirst();
  ...
  protected String defaultClassifierString() {
    ...
    return "features.classifiers.trees.J48";
  }
  ...
  public AttributeSelectedClassifier() {
    m_Classifier = new features.classifiers.trees.J48();
  }
  ...
  public Enumeration listOptions() {
    ...
    newVector.addElement(new Option(
	      ...
	      + "\tby its options.\n"
	      + "\teg: \"features.attributeSelection.CfsSubsetEval -L\"\n"
	      + "\t(default features.attributeSelection.CfsSubsetEval)",
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    if (evaluatorString.length() == 0)
      evaluatorString = features.attributeSelection.CfsSubsetEval.class.getName();
