...
import features.classifiers.functions.LinearRegression;
import features.core.AdditionalMeasureProducer;
import features.core.Capabilities;
import features.core.Debug;
...
import features.core.PropertyPath;
...
import features.core.Summarizable;
...
import features.filters.supervised.attribute.PLSFilter;
import features.filters.unsupervised.attribute.MathExpression;
import features.filters.unsupervised.attribute.NumericCleaner;
import features.filters.unsupervised.instance.Resample;
 ...
 *  (default: features.filters.supervised.attribute.PLSFilter)</pre>
 * 
 ...
 *  (default: features.classifiers.functions.LinearRegression)</pre>
 * 
 * <pre> 
 * Options specific to classifier features.classifiers.functions.LinearRegression:
 * </pre>
 * 
 * <pre> -D
 ...
 * 
 * <pre> 
 * Options specific to filter features.filters.supervised.attribute.PLSFilter ('-filter'):
 * </pre>
 * 
 * <pre> -D
 ...
 *       <li>Set the filter to <code>features.filters.AllFilter</code> since we
 ...
 *       <li>Set <code>features.classifiers.functions.SMO</code> as classifier
 *           with <code>features.classifiers.functions.supportVector.RBFKernel</code>
 *           as kernel.
 *       </li>
 ...
 *       <li>Set the filter to <code>features.filters.supervised.attribute.PLSFilter</code>.</li>
 *       <li>Set <code>features.classifiers.functions.LinearRegression</code> as 
...
public class GridSearch
  ...
  public Enumeration listOptions(){
	...
	"\tThe filter to use (on X axis). Full classname of filter to include, \n"
	+ "\tfollowed by scheme options.\n"
	+ "\t(default: features.filters.supervised.attribute.PLSFilter)",
