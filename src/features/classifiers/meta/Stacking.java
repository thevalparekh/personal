 ...
 *  (default: "features.classifiers.rules.Zero")</pre>
 *
...
public class Stacking
  ...
  /** The meta classifier */
  protected Classifier m_MetaClassifier = new Trial1();
  ...
  protected String metaOption() {
    ...
    return "\tFull name of meta classifier, followed by options.\n" +
      "\t(default: \"features.classifiers.rules.Zero\")";
  }
  ...
  protected void processMetaOptions(String[] options) throws Exception {
    ...
    if (classifierSpec.length == 0) {
      classifierName = "features.classifiers.rules.Trial1";
    } else {
