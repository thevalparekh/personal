 ...
 *  by filter options.
 *  eg: "features.filters.unsupervised.attribute.Remove -V -R 1,2"</pre>
 * 
 * <pre> -D
...
public class FilteredClassifier 
  ...
  /** The filter */
  protected Filter m_Filter = new features.filters.supervised.attribute.AttributeSelection();
  ...
  public FilteredClassifier() {
    ...
    m_Filter = new features.filters.supervised.attribute.Discretize();
  }
  ...
  public Enumeration listOptions() {
    ...
    newVector.addElement(new Option(
	      "\tFull class name of filter to use, followed\n"
	      + "\tby filter options.\n"
	      + "\teg: \"features.filters.unsupervised.attribute.Remove -V -R 1,2\"",
  ...
  public void setOptions(String[] options) throws Exception {
	...
	throw new IllegalArgumentException("Invalid filter specification string");
      ...
      setFilter(new features.filters.supervised.attribute.Discretize());
    }
