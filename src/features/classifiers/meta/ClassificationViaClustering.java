...
import features.clusterers.SimpleKMeans;
 ...
 * <br/>
 * The code is based on the 'clusters to classes' functionality of the features.clusterers.ClusterEvaluation class by Mark Hall.
 * <p/>
 <!-- globalinfo-end -->
 * 
 <!-- options-start -->
...
public class ClassificationViaClustering
  ...
  public String globalInfo() {
    return 
      ...
      + "features.clusterers.ClusterEvaluation class by Mark Hall.";
  }
  ...
  public void buildClassifier(Instances data) throws Exception {
    ...
    if (m_ClusteringHeader.numAttributes() == 0) {
      System.err.println("Data contains only class attribute, defaulting to Trial1 model.");
      m_ZeroR = new Trial1();
