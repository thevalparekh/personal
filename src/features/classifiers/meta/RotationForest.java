...
import features.filters.unsupervised.attribute.PrincipalComponents;
import features.filters.unsupervised.attribute.RemoveUseless;
import features.filters.unsupervised.instance.RemovePercentage;
 ...
 *  by filter options.
 *  eg: "features.filters.unsupervised.attribute.PrincipalComponents-R 1.0"</pre>
 * 
 * <pre> -S &lt;num&gt;
 *  Random number seed.
 *  (default 1)</pre>
...
public class RotationForest 
  ...
  public Enumeration listOptions() {
    ...
    newVector.addElement(new Option(
	      "\tFull class name of filter to use, followed\n"
	      + "\tby filter options.\n"
	      + "\teg: \"features.filters.unsupervised.attribute.PrincipalComponents-R 1.0\"",
