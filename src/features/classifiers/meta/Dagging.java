 ...
 *  (default: features.classifiers.functions.SMO)</pre>
 * 
 * <pre> 
 * Options specific to classifier features.classifiers.functions.SMO:
 * </pre>
 * 
 * <pre> -D
 *  If set, classifier is run in debug mode and
...
public class Dagging
   ...
   */
  public Dagging() {
    m_Classifier = new features.classifiers.functions.SMO();
  }
  ...
  protected String defaultClassifierString() {
    return features.classifiers.functions.SMO.class.getName();
  }
