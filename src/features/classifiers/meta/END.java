...
package features.classifiers.meta;
...
import features.classifiers.RandomizableIteratedSingleClassifierEnhancer;
import features.core.Capabilities;
import features.core.Instance;
import features.core.Instances;
import features.core.Randomizable;
 ...
 *  (default: features.classifiers.meta.nestedDichotomies.ND)</pre>
 * 
 * <pre> 
 * Options specific to classifier features.classifiers.meta.nestedDichotomies.ND:
 * </pre>
 * 
 * <pre> -S &lt;num&gt;
 *  Random number seed.
 ...
 * <pre> -W
 *  Full name of base classifier.
 *  (default: features.classifiers.trees.J48)</pre>
 * 
 * <pre> 
 * Options specific to classifier features.classifiers.trees.J48:
 * </pre>
 * 
 * <pre> -U
...
public class END 
  ...
  public END() {
    ...
    m_Classifier = new features.classifiers.meta.nestedDichotomies.ND();
  }
  ...
  protected String defaultClassifierString() {
    ...
    return "features.classifiers.meta.nestedDichotomies.ND";
  }
  ...
  public void buildClassifier(Instances data) throws Exception {
    ...
    if (!(m_Classifier instanceof features.classifiers.meta.nestedDichotomies.ND) && 
	!(m_Classifier instanceof features.classifiers.meta.nestedDichotomies.ClassBalancedND) &&  
	!(m_Classifier instanceof features.classifiers.meta.nestedDichotomies.DataNearBalancedND)) {
    ...
    for (int j = 0; j < m_Classifiers.length; j++) {
      ...
      // Set the hashtable
      if (m_Classifier instanceof features.classifiers.meta.nestedDichotomies.ND) 
	((features.classifiers.meta.nestedDichotomies.ND)m_Classifiers[j]).setHashtable(m_hashtable);
      else if (m_Classifier instanceof features.classifiers.meta.nestedDichotomies.ClassBalancedND) 
	((features.classifiers.meta.nestedDichotomies.ClassBalancedND)m_Classifiers[j]).setHashtable(m_hashtable);
      else if (m_Classifier instanceof features.classifiers.meta.nestedDichotomies.DataNearBalancedND) 
	((features.classifiers.meta.nestedDichotomies.DataNearBalancedND)m_Classifiers[j]).
