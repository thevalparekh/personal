 ...
 *  (default: features.classifiers.trees.DecisionStump)</pre>
 * 
 * <pre> 
 * Options specific to classifier features.classifiers.trees.DecisionStump:
 * </pre>
 * 
 * <pre> -D
 *  If set, classifier is run in debug mode and
...
public class LWL 
   ...
   */
  public LWL() {    
    m_Classifier = new features.classifiers.trees.DecisionStump();
  }
  ...
  protected String defaultClassifierString() {
    ...
    return "features.classifiers.trees.DecisionStump";
  }
