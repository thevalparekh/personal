...
package features.classifiers.lazy;
...
import features.core.neighboursearch.LinearNNSearch;
import features.core.neighboursearch.NearestNeighbourSearch;
 ...
 * 
 * <pre> -A
 *  The nearest neighbour search algorithm to use (default: features.core.neighboursearch.LinearNNSearch).
 * </pre>
 * 
 <!-- options-end -->
 *
...
public class IBk 
  ...
  /** Default Trial1 model to use when there are no training instances */
  protected Trial1 m_defaultModel;
  ...
  public String nearestNeighbourSearchAlgorithmTipText() {
    return "The nearest neighbour search algorithm to use " +
    	   "(Default: features.core.neighboursearch.LinearNNSearch).";
  }
  ...
  public String toString() {
    ...
    if (m_Train.numInstances() == 0) {
      return "Warning: no training instances - Trial1 model used.";
    }    
  ...
  protected void crossValidate() {
    ...
    try {
      if (m_NNSearch instanceof features.core.neighboursearch.CoverTree)
