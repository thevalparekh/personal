...
package features.classifiers.functions.supportVector;
 ...
 * kernels. If you implement an kernels using the features.libraries,
 ...
 * 
 * Typical usage: <p/>
 * <code>java features.classifiers.functions.supportVector.CheckKernel -W kernel_name 
 ...
 *
 * The <code>features.classifiers.AbstractKernelTest</code> uses this
 ...
 *  eg: features.classifiers.functions.supportVector.RBFKernel
 *  (default features.classifiers.functions.supportVector.RBFKernel)</pre>
 * 
 * <pre> 
...
public class CheckKernel
  ...
  protected Kernel m_Kernel = new features.classifiers.functions.supportVector.RBFKernel();
  ...
  public Enumeration listOptions() {
    ...
    result.addElement(new Option(
        "\tFull name of the kernel analysed.\n"
        +"\teg: features.classifiers.functions.supportVector.RBFKernel\n"
        + "\t(default features.classifiers.functions.supportVector.RBFKernel)",
        "W", 1, "-W"));
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    if (tmpStr.length() == 0)
      tmpStr = features.classifiers.functions.supportVector.RBFKernel.class.getName();
    setKernel(
	(Kernel) forName(
	    "features.classifiers.functions.supportVector", 
	    Kernel.class, 
	    tmpStr, 
