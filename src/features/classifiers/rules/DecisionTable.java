...
package features.classifiers.rules;
...
import features.attributeSelection.ASEvaluation;
import features.attributeSelection.ASSearch;
import features.attributeSelection.BestFirst;
import features.attributeSelection.SubsetEvaluator;
import features.classifiers.Classifier;
import features.classifiers.Evaluation;
import features.classifiers.lazy.IBk;
 ...
 *  by its options.
 *  eg: "features.attributeSelection.BestFirst -D 1"
 *  (default features.attributeSelection.BestFirst)</pre>
 * 
 ...
 * 
 * <pre> 
 * Options specific to search method features.attributeSelection.BestFirst:
 * </pre>
 * 
 * <pre> -P &lt;start set&gt;
...
//	if (ok) {
  ...
  public Enumeration listOptions() {
	...
	+ "\tby its options.\n"
	+ "\teg: \"features.attributeSelection.BestFirst -D 1\"\n"
	+ "\t(default features.attributeSelection.BestFirst)",
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    if (searchString.length() == 0)
      searchString = features.attributeSelection.BestFirst.class.getName();
  ...
  public void buildClassifier(Instances data) throws Exception {
    ...
    if (m_theInstances.classAttribute().isNumeric()) {
      m_disTransform = new features.filters.unsupervised.attribute.Discretize();
      m_classIsNominal = false;

      // use binned discretisation if the class is numeric
      ((features.filters.unsupervised.attribute.Discretize)m_disTransform).
      setBins(10);
      ((features.filters.unsupervised.attribute.Discretize)m_disTransform).
      ...
      m_disTransform = new features.filters.supervised.attribute.Discretize();
      ((features.filters.supervised.attribute.Discretize)m_disTransform).setUseBetterEncoding(true);
