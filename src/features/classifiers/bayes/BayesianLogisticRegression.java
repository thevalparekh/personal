...
import features.classifiers.bayes.blr.GaussianPriorImpl;
import features.classifiers.bayes.blr.LaplacePriorImpl;
import features.classifiers.bayes.blr.Prior;
...
public class BayesianLogisticRegression extends Classifier
  ...
  /**  Array to store Hyperparameter values for each features. */
  ...
  /** Filter interface used to point to features.filters.unsupervised.attribute.Normalize object
   *
   */
