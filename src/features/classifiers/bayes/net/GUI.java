 ...
 *
 */
package features.classifiers.bayes.net;
...
import features.classifiers.bayes.net.MarginCalculator.JunctionTreeNode;
...
import features.gui.graphvisualizer.BIFParser;
import features.gui.graphvisualizer.GraphNode;
import features.gui.graphvisualizer.HierarchicalBCEngine;
import features.gui.graphvisualizer.LayoutCompleteEvent;
import features.gui.graphvisualizer.LayoutCompleteEventListener;
import features.gui.graphvisualizer.LayoutEngine;
...
public class GUI extends JPanel implements LayoutCompleteEventListener {
	...
	/** path for icons */
	private final String ICONPATH = "features/classifiers/bayes/net/icons/";
	...
	class MyAction extends AbstractAction {
		...
		public MyAction(String sName, String sToolTipText, String sIcon, String sAcceleratorKey) {
			...
			if (tempURL != null) {
				...
				//System.err.println(ICONPATH + sIcon + ".png not found for features.gui.graphvisualizer.Graph");
			}
		} // c'tor
	...
	public static void main(String[] args) {
		...
		features.core.logging.Logger.log(features.core.logging.Logger.Level.INFO, "Logging started");
