...
import features.classifiers.bayes.net.ADNode;
import features.classifiers.bayes.net.BIFReader;
import features.classifiers.bayes.net.ParentSet;
import features.classifiers.bayes.net.estimate.BayesNetEstimator;
import features.classifiers.bayes.net.estimate.DiscreteEstimatorBayes;
import features.classifiers.bayes.net.estimate.SimpleEstimator;
import features.classifiers.bayes.net.search.SearchAlgorithm;
import features.classifiers.bayes.net.search.local.K2;
import features.classifiers.bayes.net.search.local.LocalScoreSearchAlgorithm;
import features.classifiers.bayes.net.search.local.Scoreable;
...
import features.filters.supervised.attribute.Discretize;
 ...
 * <br/>
 * http://sourceforge.net/projects/features/files/documentation/WekaManual-3-6-1.pdf/download
 * <p/>
 <!-- globalinfo-end -->
 * 
 <!-- options-start -->
 ...
 * </pre>
 * 
 * <pre> -Q features.classifiers.bayes.net.search.SearchAlgorithm
 *  Search algorithm
 * </pre>
 * 
 * <pre> -E features.classifiers.bayes.net.estimate.SimpleEstimator
 *  Estimator algorithm
 * </pre>
 * 
 <!-- options-end -->
...
public class BayesNet
  ...
  public Enumeration listOptions() {
    ...
    newVector.addElement(new Option("\tSearch algorithm\n", "Q", 1, "-Q features.classifiers.bayes.net.search.SearchAlgorithm"));
    newVector.addElement(new Option("\tEstimator algorithm\n", "E", 1, "-E features.classifiers.bayes.net.estimate.SimpleEstimator"));
  ...
  public String globalInfo() {
    ...
    + "http://www.cs.waikato.ac.nz/~remco/features.pdf";
  }
