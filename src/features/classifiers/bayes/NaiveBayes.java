...
import features.estimators.DiscreteEstimator;
...
implements OptionHandler, WeightedInstancesHandler, 
   ...
   */
  protected features.filters.supervised.attribute.Discretize m_Disc = null;
  ...
  public void buildClassifier(Instances instances) throws Exception {
    ...
    if (m_UseDiscretization) {
      m_Disc = new features.filters.supervised.attribute.Discretize();
      m_Disc.setInputFormat(m_Instances);
      m_Instances = features.filters.Filter.useFilter(m_Instances, m_Disc);
    } else {
      m_Disc = null;
    }
